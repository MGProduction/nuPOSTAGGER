...
// ************************************************************
//
//  A C64 sample program that uses nuPOSTAGGER (a minimal English
//  PosTagger)
//
//  Enter your text (max two lines), press enter, wait few seconds
//  and read the postagged information
//
//  You need CC65 [https://cc65.github.io/] to build this program
//
// ************************************************************
...
#define NUPOSTAG_NOMALLOCDEPENDENCIES

#define NUPOSTAG_PETSCII
#define NUPOSTAG_8BITCODE
